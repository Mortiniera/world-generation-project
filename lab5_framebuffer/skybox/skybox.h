    ...
    public:
        void Init() {
            ...
            //afternoon
            {
                ...
                int height;
                int nb_component;
                string texture_filename = "afternoon.jpg";
...

            {
                ...
                int height;
                int nb_component;
                string texture_filename = "night.jpg";
                stbi_set_flip_vertically_on_load(1);
                unsigned char* image = stbi_load(texture_filename.c_str(),
                                                 &width, &height, &nb_component, 0);
                ...
                glGenTextures(1, &night_id_);
                glBindTexture(GL_TEXTURE_2D, night_id_);
                glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
                glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
                ...
                GLuint night_id = glGetUniformLocation(program_id_, "night");
                glUniform1i(night_id, 1 /*GL_TEXTURE0*/);
            ...
            //sunset
            {
                ...
                int height;
                int nb_component;
                string texture_filename = "sunset.jpg";
                stbi_set_flip_vertically_on_load(1);
                unsigned char* image = stbi_load(texture_filename.c_str(),
                                                 &width, &height, &nb_component, 0);
                ...
                glGenTextures(1, &sunset_id_);
                glBindTexture(GL_TEXTURE_2D, sunset_id_);
                glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
                glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
                ...
                GLuint set_id = glGetUniformLocation(program_id_, "sunset");
                glUniform1i(set_id, 2 /*GL_TEXTURE0*/);
        ...
        void Draw(const glm::mat4& model,
                  const glm::mat4& view,
                  const glm::mat4& projection, int day_time) {
            ...
            glUniform1i(glGetUniformLocation(program_id_, "day_time"), day_time);
